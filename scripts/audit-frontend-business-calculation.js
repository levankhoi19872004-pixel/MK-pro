...
if (require.main === module) {
  ...
  const report = scanProfile('frontend');
...
module.exports = { runAudit: () => scanProfile('frontend'), analyzeText: (source, relPath = 'inline.js') => analyzeText(source, relPath, 'frontend') };
