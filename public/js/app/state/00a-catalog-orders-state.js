...
const applyProductFiltersButton=document.getElementById('applyProductFiltersButton');
const clearProductFiltersButton=document.getElementById('clearProductFiltersButton');
const reloadProductsButton=document.getElementById('reloadProductsButton');
...
const stockApplyFiltersButton=document.getElementById('stockApplyFiltersButton');
const stockClearFiltersButton=document.getElementById('stockClearFiltersButton');
const stockReloadButton=document.getElementById('stockReloadButton');
