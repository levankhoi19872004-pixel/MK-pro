...
var bar=el("mWorkflowBar");if(bar){var order=currentOrder();if(bar.className="m-workflow-bar delivery-one-hand-bar m-delivery-bottom-action",
!isCustomerMode()||!order||"orders"===state.tab)return bar.hidden=!0,void(bar.innerHTML="");if(bar.hidden=!1,
bar.className="m-workflow-bar delivery-one-hand-bar m-delivery-bottom-action active",bar.classList.add("active"),"products"!==state.tab){
