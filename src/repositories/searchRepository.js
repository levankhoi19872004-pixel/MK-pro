...
async function findProducts(query = {}) {
  ...
  return Product.find(filter)
    .select('id code sku productCode name productName unit baseUnit conversionRate packing barcode category brand salePrice price minStock maxStock isActive')
    .sort({ code: 1 })
