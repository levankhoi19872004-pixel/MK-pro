    ...
    for (const row of group) {
      ...
      if (rawPromoQuantity > 0) {
        items.push({
          ...
          priceAfterTaxBeforePromotionSource: 'promotion_free_item',
          listPriceBeforeVat: 0,
          preTaxPriceAtOrder: 0,
          listPriceAfterVat: 0,
          priceAfterTaxBeforePromotionAtOrder: 0,
          priceAfterTaxBeforePromotion: 0,
          priceBeforeTax: 0,
          taxAmount: 0,
          vatAmount: 0,
          vatAmountAtOrder: 0,
          ...
          referenceCatalogSalePriceAtOrder: catalogSalePriceAtOrder,
          finalPrice: 0,
          finalPriceAtOrder: 0,
          ...
          productSnapshot: {
            ...
            salePrice: 0,
            referenceSalePrice: catalogSalePriceAtOrder
          }
        });
      }
    }
