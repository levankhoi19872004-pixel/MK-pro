...
const INDEX_DEFINITIONS = {
  ...
  returnOrders: [
    ...
    [{ status: 1, masterReturnId: 1 }, { name: 'idx_return_orders_status_master_return_id', sparse: true }],
    [{ status: 1, masterReturnOrderId: 1 }, { name: 'idx_return_orders_status_master_return_order_id', sparse: true }],
    [{ status: 1, masterReturnOrderCode: 1 }, { name: 'idx_return_orders_status_master_return_order_code', sparse: true }],
