...
;function b(){return require("./delivery/CanonicalDeliveryFinancialScopeAdapter")}const{pickDeliveryStaffCode:v}=require("../domain/staff/staffIdentity");function w(t,n=e.todayVN()){
