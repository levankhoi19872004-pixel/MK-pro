...
const RAW_SOURCE_CONTRACTS = Object.freeze({
  ...
  'delivery-today-orders': {
    ...
    primaryCollections: ['orders'],
    secondaryCollections: ['masterOrders(metadata-only)', 'returnOrders', 'deliveryCloseoutVersions', 'orderPaymentAllocations'],
    ...
    exportEndpoint: null,
    sourceLabel: 'Đơn giao hôm nay từ orders/salesOrders canonical; masterOrders chỉ metadata',
    ssotRule: 'Delivery today orders = orders/salesOrders; masterOrders chỉ metadata/gán NVGH nếu thiếu; returns = returnOrders; corrections = deliveryCloseoutVersions latest; payment final state = orderPaymentAllocations current.',
    amountSource: 'orders_recomputed',
    deliverySource: 'orders',
    visibleOnUi: true,
    visibleInExcel: true,
