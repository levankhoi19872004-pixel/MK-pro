...
router.put('/sales/orders/:id', requireMobileLogin, requireMobileRole(['sales', 'admin']), async (req, res) => {
  try {
    ...
    Object.assign(order, {
      ...
      vatInvoiceRequired: raw.vatInvoiceRequired !== false,
      vatInvoiceDecisionSource: raw.vatInvoiceDecisionSource || 'default',
      vatInvoiceNote: String(raw.vatInvoiceNote || ''),
      vatInvoiceUpdatedAt: String(raw.vatInvoiceUpdatedAt || ''),
      vatInvoiceUpdatedBy: String(raw.vatInvoiceUpdatedBy || ''),
      updatedAt: new Date().toISOString(),
